...
$stid = oci_parse($conn, 'SELECT * FROM vizsgaztat');
oci_execute($stid);


?> <form action="./vizsgaztatHozzaad.php" method="POST"><?php
...
while ($row = oci_fetch_array($stid, OCI_ASSOC+OCI_RETURN_NULLS)) {
    ...
    ?> <form action="../tools/vizsgaztatModositTool.php" method="POST"><?php
    ...
    ?> <form action="../tools/vizsgaztatTorolTool.php" method="POST"><?php
    ?> <input type="hidden" name="ehakod" value="<?php echo $row["OKTATO_EHA_KOD"]  ?>"> <?php
    ?> <input type="hidden" name="azonosito" value="<?php echo $row["AZONOSITO"] ?>"> <?php
